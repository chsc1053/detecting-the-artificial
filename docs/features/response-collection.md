...
3. **Trials** — One question at a time: forced-choice (two tappable cards, any modality via `StimulusView`; optional **Compare in fullscreen** when both options are image or video) or single-item; confidence 1–5; optional open-ended explanation; **Next**.
